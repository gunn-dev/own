...
@section('content')
    ...
    <form id="child-form" action="{{ route('child') }}" method="post" role="form" style="display: block;">
        ...
        @csrf
        <h3 class="mm-font">ကလေး အမည်ပေး</h3>
        ...
        <input type="radio" name="gender" value="0" required> <span for="" class="mm-font"> ယောကျ်ားလေး </span>
        <input type="radio" name="gender" value="1" required> <span for="" class="mm-font"> မိန်းကလေး </span>
        <br>
        <br>
